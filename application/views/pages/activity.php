<div class="content-wrapper">
          <h3 class="page-heading mb-4">Activity</h3>
          <?php 
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                      ...
                      <div class="mb-4">
                        <table class="table table-hover">
                          ...
                          <tbody>
                            <?php
                            $no = 0;
                            $sqla = $this->Crud->search('enum', array('type' => 'activity', 'IdDevice' => $value['id']))->result_array();
                    ...
                    <div class="col-12">
                      ...
                      <form class="form-inline" method="post" action="<?php echo base_url('dash/save/activity');?>">
                        <div class="form-group mx-sm-8 mb-2">
                          <input type="hidden" value="<?php echo $value['id'];?>" name="iddevice">
                          <input type="text" class="form-control p-input" name="namesave" placeholder="Enter Add Activity">
                        </div>
                        <button type="submit" class="btn btn-link mb-2" name="save"><i class="fa fa-plus-circle fa-lg"></i>  Add Activity</button>
                      </form>
                      </p>
                    </div>
                  </div>
