<div class="content-wrapper">
          <h3 class="page-heading mb-4">Case of Cause</h3>
          <?php 
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                      ...
                      <div class="mb-4">
                        <table class="table table-hover">
                          ...
                          <tbody>
                            <?php
                            $no = 0;
                            $sqla = $this->Crud->search('enum', array('type' => 'case', 'IdDevice' => $value['id']))->result_array();
                    ...
                    <div class="col-12">
                      ...
                      <form class="form-inline" method="post" action="<?php echo base_url('dash/save/cases');?>">
                        ...
                        <button type="submit" class="btn btn-link mb-2" name="save"><i class="fa fa-plus-circle fa-lg"></i>  Add Case</button>
                      </form>
                      </p>
                    </div>
                  </div>
